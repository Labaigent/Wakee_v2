...
- **n8n**: webhooks para activar flujos de actualización:
  ...
  - `E6 Búsqueda`: Ejecución de búsqueda de leads con tracking de progreso en tiempo real vía Supabase (Etapa Búsqueda).
...
3. Configura las variables de entorno. Crea un `.env` con al menos:
   ...
   - `VITE_N8N_E6_BUSQUEDA_WEBHOOK_URL` (flujo Segmentación / Búsqueda → tracking de progreso en tiempo real).
